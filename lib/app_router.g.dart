...
List<RouteBase> get $appRoutes => [$splashRoute, $mainShellRoute];
...
RouteBase get $mainShellRoute => StatefulShellRouteData.$route(
  ...
  branches: [
    StatefulShellBranchData.$branch(
      routes: [
        GoRouteData.$route(path: '/dice', factory: $DiceRoute._fromState),
      ],
    ),
    StatefulShellBranchData.$branch(
      routes: [
...
mixin $DiceRoute on GoRouteData {
  static DiceRoute _fromState(GoRouterState state) => const DiceRoute();

  @override
  String get location => GoRouteData.$location('/dice');
